...
Route::middleware('api')->group(function () {
    ...
    // Mock / testing endpoints (no auth) - use only for local development
    Route::post('/payments/mock/payme/{id}', [MockPaymentController::class, 'simulatePaymeCallback']);
    Route::post('/payments/mock/click/{id}', [MockPaymentController::class, 'simulateClickCallback']);
